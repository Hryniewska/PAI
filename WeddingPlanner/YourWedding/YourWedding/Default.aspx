...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">pragną połączyć swe losy węzłem małżeńskiej przysięgi poprzez zawarcie Sakramentu Małżeństwa
w kościele św. Wita w Łodzi dnia 16 maja 2018 roku o godzinie 15.00</p>
        <p><a href="http://www.asp.net" class="btn btn-primary btn-large">Więcej o nas &raquo;</a></p>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p>
                Bardzo serdecznie prosimy, abyście potwierdzili swoją obecność na naszym weselu do 15 kwietnia. W przypadku, gdyby któryś z zacnych Gości nie mógł przybyć na przyjęcie weselne, prosimy aby nas powiadomił. </p>
            <p>
